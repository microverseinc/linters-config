...
1. Run `yarn add eslint@7.11.x eslint-config-airbnb@18.1.x eslint-plugin-import@2.20.x eslint-plugin-jsx-a11y@6.2.x eslint-plugin-react@7.20.x eslint-plugin-react-hooks@2.5.x babel-eslint@10.1.x --dev` (not sure how to use yarn? Read [this](https://yarnpkg.com/getting-started/install)).
